...
\includegraphics[scale=0.7]{images/FabrikIteration.jpg}
...
\begin{equation}
\textbf{p}_{n-1}^{'}= \textbf{p}_{n}^{'}+ (\overline{AB}\cdot\textbf{d}_{n-1})
\end{equation}
